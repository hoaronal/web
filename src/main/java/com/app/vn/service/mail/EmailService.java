 ...
 * =============================================================================
 */
package com.app.vn.service.mail;
...
public class EmailService {
    ...
    private static final String EMAIL_SIMPLE_TEMPLATE_NAME = "template/email/html/email-simple";
    private static final String EMAIL_WITHATTACHMENT_TEMPLATE_NAME = "template/email/html/email-withattachment";
    private static final String EMAIL_INLINEIMAGE_TEMPLATE_NAME = "template/email/html/email-inlineimage";

    private static final String BACKGROUND_IMAGE = "template/email/mail/editablehtml/images/background.png";
    private static final String LOGO_BACKGROUND_IMAGE = "template/email/mail/editablehtml/images/logo-background.png";
    private static final String THYMELEAF_BANNER_IMAGE = "template/email/mail/editablehtml/images/thymeleaf-banner.png";
    private static final String THYMELEAF_LOGO_IMAGE = "template/email/mail/editablehtml/images/thymeleaf-logo.png";
